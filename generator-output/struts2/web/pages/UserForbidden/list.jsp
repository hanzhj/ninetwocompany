...
<rapid:override name="content">
	<form id="queryForm" name="queryForm" action="<c:url value="/pages/UserForbidden/list.do"/>" method="get" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
			<input type="submit" class="stdButton" style="width:80px" value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/UserForbidden/list.do'"/>
			<input type="submit" class="stdButton" style="width:80px" value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/UserForbidden/create.do'"/>
			<input type="button" class="stdButton" style="width:80px" value="删除" onclick="batchDelete('${ctx}/pages/UserForbidden/delete.do','items',document.forms.queryForm)"/>
		<div>
	</div>
		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  ...
		  <tbody>
			  ...
			  <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td>
					<a href="${ctx}/pages/UserForbidden/show.do?id=${item.id}&">查看</a>&nbsp;&nbsp;&nbsp;
					<a href="${ctx}/pages/UserForbidden/edit.do?id=${item.id}&">修改</a>
				</td>
			  </tr>
